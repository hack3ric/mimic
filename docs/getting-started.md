...
To use it, first create a configuration for an interface at `/etc/mimic/<interface>.conf`. See [`/etc/mimic/eth0.conf.example`](../install/eth0.conf.example) for example configuration.
